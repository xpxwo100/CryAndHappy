...
public class RemoteProxyByThrift {

  public interface Iface {

    public ReSult load(DataWrapper dataWrapper) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void load(DataWrapper dataWrapper, org.apache.thrift.async.AsyncMethodCallback<ReSult> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public ReSult load(DataWrapper dataWrapper) throws org.apache.thrift.TException
    {
      send_load(dataWrapper);
      return recv_load();
    }

    public void send_load(DataWrapper dataWrapper) throws org.apache.thrift.TException
    {
      load_args args = new load_args();
      args.setDataWrapper(dataWrapper);
      sendBase("load", args);
    }

    public ReSult recv_load() throws org.apache.thrift.TException
    {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class load<I extends Iface> extends org.apache.thrift.ProcessFunction<I, load_args> {
      ...
      public load_result getResult(I iface, load_args args) throws org.apache.thrift.TException {
        load_result result = new load_result();
        result.success = iface.load(args.dataWrapper);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class load<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, load_args, ReSult> {
      public load() {
        super("load");
      }
      ...
      public void start(I iface, load_args args, org.apache.thrift.async.AsyncMethodCallback<ReSult> resultHandler) throws org.apache.thrift.TException {
        iface.load(args.dataWrapper,resultHandler);
      }
    }
  ...
  public static class load_args implements org.apache.thrift.TBase<load_args, load_args._Fields>, java.io.Serializable, Cloneable, Comparable<load_args>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_WRAPPER_FIELD_DESC = new org.apache.thrift.protocol.TField("dataWrapper", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public DataWrapper dataWrapper; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      DATA_WRAPPER((short)1, "dataWrapper");
    ...
    static {
      ...
      tmpMap.put(_Fields.DATA_WRAPPER, new org.apache.thrift.meta_data.FieldMetaData("dataWrapper", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT          , "DataWrapper")));
    ...
    public load_args(load_args other) {
      if (other.isSetDataWrapper()) {
        this.dataWrapper = new DataWrapper(other.dataWrapper);
      }
    }
    ...
    public load_args setDataWrapper(DataWrapper dataWrapper) {
      this.dataWrapper = dataWrapper;
      return this;
    }

    public void unsetDataWrapper() {
      this.dataWrapper = null;
    }

    /** Returns true if field dataWrapper is set (has been assigned a value) and false otherwise */
    public boolean isSetDataWrapper() {
      return this.dataWrapper != null;
    }

    public void setDataWrapperIsSet(boolean value) {
      if (!value) {
        this.dataWrapper = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case DATA_WRAPPER:
        if (value == null) {
          ...
          setDataWrapper((DataWrapper)value);
        }
        break;
    ...
    public boolean equals(load_args that) {
      ...
      boolean this_present_dataWrapper = true && this.isSetDataWrapper();
      boolean that_present_dataWrapper = true && that.isSetDataWrapper();
      if (this_present_dataWrapper || that_present_dataWrapper) {
        if (!(this_present_dataWrapper && that_present_dataWrapper))
          return false;
        if (!this.dataWrapper.equals(that.dataWrapper))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDataWrapper()) ? 131071 : 524287);
      if (isSetDataWrapper())
        hashCode = hashCode * 8191 + dataWrapper.hashCode();
    ...
    public int compareTo(load_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetDataWrapper()).compareTo(other.isSetDataWrapper());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataWrapper()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataWrapper, other.dataWrapper);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    private static class load_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<load_args> {
          ...
          switch (schemeField.id) {
            case 1: // DATA_WRAPPER
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataWrapper = new DataWrapper();
                struct.dataWrapper.read(iprot);
                struct.setDataWrapperIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, load_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.dataWrapper != null) {
          oprot.writeFieldBegin(DATA_WRAPPER_FIELD_DESC);
          struct.dataWrapper.write(oprot);
          oprot.writeFieldEnd();
        }
  ...
  public static class load_result implements org.apache.thrift.TBase<load_result, load_result._Fields>, java.io.Serializable, Cloneable, Comparable<load_result>   {
    ...
    public load_result setSuccess(ReSult success) {
      this.success = success;
      return this;
    }
