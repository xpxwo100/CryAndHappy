/*
 * underscore.string 3.2.1 | MIT licensed |
	...
	if ("object" == typeof exports)
		...
		"undefined" != typeof window
				...
				: "undefined" != typeof global
						? f = global
						: "undefined" != typeof self && (f = self), f.s = e()
	}
}(function() {
	...
	return (function e(t, n, r) {
		...
		2 : [function(_dereq_, module, exports) {
			...
			module.exports = function capitalize(str, lowercaseRest) {
				str = makeString(str);
				var remainingChars = !lowercaseRest ? str.slice(1) : str
						.slice(1).toLowerCase();
		...
		5 : [function(_dereq_, module, exports) {
			...
			module.exports = function classify(str) {
				str = makeString(str);
				return capitalize(camelize(str.replace(/[\W_]/g, ' ')).replace(
						/\s/g, ''));
			};
		...
		7 : [function(_dereq_, module, exports) {
			...
			var from = "ąàáäâãåæăćčĉęèéëêĝĥìíïîĵłľńňòóöőôõðøśșšŝťțŭùúüűûñÿýçżźž", to = "aaaaaaaaaccceeeeeghiiiijllnnoooooooossssttuuuuuunyyczzz";
		...
		12 : [function(_dereq_, module, exports) {
			...
			module.exports = function endsWith(str, ends, position) {
				...
				if (typeof position == 'undefined') {
					...
					position = Math.min(toPositive(position), str.length)
							- ends.length;
				}
				return position >= 0
						&& str.indexOf(ends, position) === position;
			};
			...
			module.exports = function() {
				...
				for (var prop in this) {
					if (!this.hasOwnProperty(prop)
							|| prop
									.match(/^(?:include|contains|reverse|join)$/))
						continue;
		...
		15 : [function(_dereq_, module, exports) {
			...
			// Underscore.string is freely distributable under the terms of the
			// MIT license.
			...
			function fn2method(key, fn) {
				...
				s.prototype[key] = function() {
					var args = [this._wrapped].concat(Array.prototype.slice
							.call(arguments));
					var res = fn.apply(null, args);
					// if the result is non-string stop the chain and return the
					// value
			...
			function prototype2method(methodName) {
				fn2method(methodName, function(context) {
							...
							return String.prototype[methodName].apply(context,
									args);
						});
			}

			var prototypeMethods = ["toUpperCase", "toLowerCase", "split",
					"replace", "slice", "substring", "substr", "concat"];
		...
		16 : [function(_dereq_, module, exports) {
			...
			module.exports = function adjacent(str, direction) {
				...
				return str.slice(0, -1)
						+ String.fromCharCode(str.charCodeAt(str.length - 1)
								+ direction);
			};
		...
		18 : [function(_dereq_, module, exports) {
					/*
					 * We're explicitly defining the list of entities we want to
					 * escape. nbsp is an HTML entity, but we don't want to
					 * escape all space characters in a string, hence its
					 * omission in this map.
					 * 
					 */
					var escapeChars = {
						'¢' : 'cent',
		...
		20 : [function(_dereq_, module, exports) {
					/*
					 * We're explicitly defining the list of entities that might
					 * see in escape HTML strings
					 */
					var htmlEntities = {
						nbsp : ' ',
						cent : '¢',
		...
		24 : [function(_dereq_, module, exports) {
			...
			module.exports = function humanize(str) {
				return capitalize(trim(underscored(str).replace(/_id$/, '')
						.replace(/_/g, ' ')));
			};
		...
		28 : [function(_dereq_, module, exports) {
					...
					module.exports = function join() {
						var args = slice.call(arguments), separator = args
								.shift();
			...
			module.exports = function levenshtein(str1, str2) {
				...
				for (i = 0; i < str1.length; ++i) {
					...
					for (var j = 0; j < str2.length; ++j) {
						...
						// copy current col value into previous (in preparation
						// for next iteration)
						prevRow[j] = curCol;
					}

					// copy last col value into previous (in preparation for
					// next iteration)
					prevRow[j] = nextCol;
				}
		...
		34 : [function(_dereq_, module, exports) {
			module.exports = function naturalCmp(str1, str2) {
				...
				var cmpRegex = /(\.\d+|\d+|\D+)/g, tokens1 = String(str1)
						.match(cmpRegex), tokens2 = String(str2)
						.match(cmpRegex), count = Math.min(tokens1.length,
						tokens2.length);
		...
		35 : [function(_dereq_, module, exports) {
			module.exports = function numberFormat(number, dec, dsep, tsep) {
				...
				var parts = number.split('.'), fnums = parts[0], decimals = parts[1]
						? (dsep || '.') + parts[1]
						: '';
		...
		38 : [function(_dereq_, module, exports) {
			/**
			 * _s.prune: a more elegant version of truncate prune extra chars,
			 * never leaving a half-chopped word.
			 * 
			...
			module.exports = function prune(str, length, pruneStr) {
				...
				}, template = str.slice(0, length + 1).replace(/.(?=\W*\w*$)/g,
						tmpl); // 'Hello, world' -> 'HellAA AAAAA'
				...
				return (template + pruneStr).length > str.length ? str : str
		...
		40 : [function(_dereq_, module, exports) {
					...
					module.exports = function repeat(str, qty, separator) {
						...
						// using faster implementation if separator is not
						// needed;
						if (separator == null)
		...
		47 : [function(_dereq_, module, exports) {
			...
			//
			// Copyright (c) Alexandru Marasteanu <alexaholic [at) gmail (dot]
			// com>
			// All rights reserved.
			var strRepeat = _dereq_('./helper/strRepeat');
		...
		48 : [function(_dereq_, module, exports) {
			...
			module.exports = function startsWith(str, starts, position) {
				str = makeString(str);
				starts = '' + starts;
				position = position == null ? 0 : Math.min(
						toPositive(position), str.length);
		...
		51 : [function(_dereq_, module, exports) {
					...
					module.exports = function strRight(str, sep) {
						...
						var pos = !sep ? -1 : str.indexOf(sep);
						return ~pos
								? str.slice(pos + sep.length, str.length)
								: str;
					};
		...
		57 : [function(_dereq_, module, exports) {
			...
			module.exports = function titleize(str) {
				return makeString(str).toLowerCase().replace(/(?:^|\s|-)\S/g,
						function(c) {
		...
		58 : [function(_dereq_, module, exports) {
					...
					module.exports = function toBoolean(str, trueValues,
							falseValues) {
		...
		59 : [function(_dereq_, module, exports) {
					...
					module.exports = function toNumber(num, precision) {
						if (num == null)
							return 0;
						var factor = Math.pow(10, isFinite(precision)
										? precision
										: 0);
		...
		60 : [function(_dereq_, module, exports) {
			...
			module.exports = function toSentence(array, separator,
					lastSeparator, serial) {
				separator = separator || ', ';
		...
		61 : [function(_dereq_, module, exports) {
					...
					module.exports = function toSentenceSerial(array, sep,
							lastSep) {
		...
		64 : [function(_dereq_, module, exports) {
			...
			module.exports = function underscored(str) {
				return trim(str).replace(/([a-z\d])([A-Z]+)/g, '$1_$2')
					...
					module.exports = function wrap(str, options) {
						...
						if (width <= 0) {
							...
							while (words.length > 0) {
								...
								// if adding a space and the next word would
								// cause this line to be longer than width...
								if (1 + words[0].length + current_column > width) {
									// start a new line if this line is not
									// already empty
									if (current_column > 0) {
										// add a space at the end of the line is
										// preserveSpaces is true
										if (preserveSpaces) {
											result += ' ';
											current_column++;
										}
										// fill the rest of the line with spaces
										// if trailingSpaces option is true
								...
								// if not at the begining of the line, add a
								...
								// tack on the next word, update current column,
								// a pop words array
								result += words[0];
							...
							// fill the rest of the line with spaces if
							// trailingSpaces option is true
							if (trailingSpaces) {
								while (current_column < width) {
									result += ' ';
									current_column++;
							...
							// walk through each character and add seperators
							// where appropriate
